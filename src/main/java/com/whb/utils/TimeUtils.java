...
public class TimeUtils {
    ...
    /**
     * 判断当前时间是否存管清算时间
     * 当日 23:55:00 次日 00:05:59
     *
     * @return 结果
     */
    public static boolean isSettlementTime() {
        // 判断是否是存管结算时间
        return !compareTo(23, 55, 0) && compareTo(0, 5, 59);
    }
     ...
     * @return 是否大于当前时间
     */
    public static boolean compareTo(int hour, int minute, int second) {
    ...
    {
        org.joda.time.LocalDate ld1 = new org.joda.time.LocalDate(new DateTime(dt1));
        org.joda.time.LocalDate ld2 = new org.joda.time.LocalDate(new DateTime(dt2));
...
//        System.out.println(between(new Date(), convertToDate("12:00"), convertToDate("12:40")));
        ...
        System.out.println(isSettlementTime());
    }
