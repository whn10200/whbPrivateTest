...
import com.whb.utils.file.CloseUtils;
...
public class MD5Utils {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(md5(md5("test123456") + "A24CX8"));
        System.out.println(md5(md5("123456+") + "96EEDW"));
        Integer x = 1314423;
        Long y = 1314423L;
        System.out.println(x.longValue());
        System.out.println(x.longValue() == y);
        Random random = new Random();
        int i = random.nextInt(2051);
        System.out.println(i);
        log.info("hello:[{}]","world");
        log.info("hello:hechuan","world");
        log.info("hello:hechuan","");
        for(int c=1;c<5;c++){
            System.out.println((long) (100 * Math.pow(1.5, c)));
        }
