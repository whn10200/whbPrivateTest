...
public enum BusinessCode
{
     ...
     */
    private static final Map<BusinessCode, String> stringToEnum = new HashMap<BusinessCode, String>();
    static
    {
        for (BusinessCode blah : values())
        {
     ...
     * @return
     */
    public static String fromString(BusinessCode symbol)
    {
